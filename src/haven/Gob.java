...
public class Gob implements Sprite.Owner, Skeleton.ModOwner, Rendered {
    ...
    public enum Type {
        ...
        MOB(32), WOLF(33), BEAR(34), LYNX(35), WILDGOAT(36), TROLL(38), WALRUS(39),
          ...
          /*if (Config.hidegobs && (type == Type.TREE || type == Type.BUSH)) {
            ...
            if (Config.showplantgrowstage) {
                if (Type.PLANT.has(type)) {
                    ...
                    if (ol == null && stage >= 0 && cropstgmaxval > 0) {
                        ...
                        ols.remove(ol);
                    } else if (cropstgmaxval > 0 && ((PlantStageSprite) ol.spr).stg != stage) {
